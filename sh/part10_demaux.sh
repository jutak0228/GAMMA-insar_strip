...
gc_map2 ${pwrdir}/${ref_date}_${polar}.rmli.par ${demdir}/EQA.dem_par ${demdir}/EQA.dem - - - 1 1 ls_map - inc
...
# look vector
look_vector ${pwrdir}/${ref_date}_${polar}.rmli.par - ${demdir}/EQA.dem_par ${demdir}/EQA.dem lv_theta lv_phi
